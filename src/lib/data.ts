...
export const products: Product[] = [
  ...
  { id: "p003", name: "T-bone steak", slug: "t-bone-steak", description: "Dva steaky v jednom – na jedné straně svíčková, na druhé roštěná. Impozantní kus masa pro opravdové milovníky steaků.", short_description: "Svíčková + roštěná v jednom", category_id: "a1000000-0000-0000-0000-000000000001", price: 1690, unit: "kg", weight_info: "800 g", image_url: null, gallery: [], stock_status: "in_stock", is_active: true, is_featured: true, badge: null, sort_order: 3, created_at: "", updated_at: "" },
